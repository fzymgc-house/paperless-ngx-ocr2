...
use paperless_ngx_ocr2::api::ocr::{OCRRequest, OCRResponse, Page, Dimensions, UsageInfo};
...
async fn test_ocr_response_contract_structure() {
    ...
    let response: OCRResponse = serde_json::from_str(api_response_json)
