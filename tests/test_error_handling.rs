...
async fn test_error_handling_invalid_file_format() {
    ...
    cmd.arg("--file")
        ...
        .stderr(predicate::str::contains("pdf").or(predicate::str::contains("png")).or(predicate::str::contains("jpg")));
...
async fn test_error_handling_file_too_large() {
    ...
    cmd.arg("--file")
        ...
        .stderr(predicate::str::contains("large").or(predicate::str::contains("size")).or(predicate::str::contains("limit")));
...
async fn test_error_handling_invalid_api_key() {
    ...
    cmd.arg("--file")
        ...
        .stderr(predicate::str::contains("auth").or(predicate::str::contains("key")).or(predicate::str::contains("invalid")));
...
async fn test_error_handling_network_timeout() {
    ...
    cmd.arg("--file")
        ...
        .stderr(predicate::str::contains("timeout").or(predicate::str::contains("network")).or(predicate::str::contains("connect")));
...
async fn test_error_handling_malformed_pdf() {
    ...
    cmd.arg("--file")
        ...
        .failure()
        .code(2) // Validation error per constitution
        .stderr(predicate::str::contains("invalid").or(predicate::str::contains("malformed")).or(predicate::str::contains("corrupt")).or(predicate::str::contains("valid PDF")));
...
async fn test_error_handling_api_rate_limit() {
    ...
    cmd.arg("--file")
        ...
        .stderr(predicate::str::contains("rate").or(predicate::str::contains("limit")).or(predicate::str::contains("429")).or(predicate::str::contains("Client error")));
