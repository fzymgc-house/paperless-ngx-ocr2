...
async fn test_api_error_response_contract_structure() {
    ...
    let error_response: APIErrorResponse = serde_json::from_str(api_error_json)
        .expect("Should deserialize from API error JSON");
...
async fn test_api_error_response_contract_optional_fields() {
    ...
    let error_response: APIErrorResponse = serde_json::from_str(full_error_json)
        .expect("Should deserialize full error response");
...
async fn test_api_error_conversion_to_cli_error() {
    ...
    let api_error: APIErrorResponse = serde_json::from_str(api_error_json)
        .expect("Should deserialize API error");
